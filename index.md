...
## 案件名
- 画像共有サイトの開発(2012/04 - 2012/06)
- ゴルフ場予約サイトの開発(2012/07 - 2012/12)
...
## 案件名
- 某就職支援サイトの開発(2010/04 - 2010/07)
- 某住宅情報サイトの開発(2010/08 - 2011/10)
...
### 業務内容
- 某就職支援サイトの詳細設計〜結合テストを担当。
- 某住宅情報サイトの基本設計〜結合テストを担当。
...
### 業務内容
某情報誌コンシューマ向けサイトのコーディング〜単体テスト(仕様書作成を含む)を担当。
...
### 業務内容
情報誌向け自動組版システム(ASP)の開発。WEBサーバ、DBサーバ、ファイルサーバの構築(OS：Linux(Debian、Ubuntu Server))
...
### 業務内容
某官公庁様向け旅費計算システムの詳細設計書作成〜単体テスト(テスト仕様書を含む)までを担当。
